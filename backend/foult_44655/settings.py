"""
Django settings for foult_44655 project.
...
WSGI_APPLICATION = 'foult_44655.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "foult_44655 API",
    "DESCRIPTION": "API documentation for foult_44655 App",
    "VERSION": "v1",
}
